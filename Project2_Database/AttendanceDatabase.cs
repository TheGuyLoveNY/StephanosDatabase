...
{
    public partial class AttendanceDatabase : Form
    {
        ...
        private void AttendanceDatabase_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Hide();
            Form membershipDatabase = new MembershipDatabase();
            membershipDatabase.Show();
